...
**F**riends · **L**overs · **A**ffectionate · **M**arriage · **E**nemies · **S**iblings
...
4. The last remaining letter reveals your relationship result — complete with an emoji!

## Features

- ✅ Input validation (letters only, no numbers or symbols)
- 🔁 Play multiple rounds without restarting the program
- 🎮 Simple, friendly command-line interface with emoji feedback
